...
class OBJECT_OT_FBDefaultSensor(Operator):
    bl_idname = Config.fb_main_default_sensor_idname
    bl_label = "Default Sensor Size"
    bl_options = {'REGISTER'}
    bl_description = "Set Sensor Size to Default (36 x 24 mm)"
...
class OBJECT_OT_FBAllUnknown(Operator):
    bl_idname = Config.fb_main_all_unknown_idname
    bl_label = "All Unknown"
    bl_options = {'REGISTER'}
    bl_description = "All parameter are unknown! I have no idea! " \
                     "Set all parameters to maximum auto mode"
