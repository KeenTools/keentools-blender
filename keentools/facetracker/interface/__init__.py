...
from .panels import (FT_PT_FacetrackersPanel,
                     FT_PT_UpdatePanel,
                     FT_PT_DownloadNotification,
                     FT_PT_DownloadingProblemPanel,
                     FT_PT_UpdatesInstallationPanel,
                     FTFB_PT_ViewsPanel,
                     FTFB_PT_OptionsPanel,
                     FTFB_PT_ModelPanel,
                     FTFB_PT_AppearancePanel,
                     FTFB_PT_ChooseSnapshotFramePanel,
                     FT_PT_InputsPanel,
                     FT_PT_CameraPanel,
                     FT_PT_TrackingPanel,
                     FT_PT_OptionsPanel,
                     FT_PT_MasksPanel,
                     FT_OT_AppearanceAddPreset,
                     FT_PT_AppearancePresetPanel,
